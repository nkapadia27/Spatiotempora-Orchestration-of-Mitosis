%% Version contains revised estimates of div length.
...
%       nuc_centroids = cell2mat({nuc_stats.Centroid}');
     ...
     % pix_intensities_iso = cell2mat(pix_intensities_cell);
      ...
      cell_inten_mean = [cell_inten_mean;mean(pix_intensities_cell)];
    ...
    Fluor_cell{i,7} = cell_inten_mean;
    ...
    res_show = {strcat('Max:', num2str(max_rate_conc)), num2str(cell_length(end)*pixel_size)};
    
    hold on
    subplot(1,2,2)
     plot(time_vals/max(time_vals), nuc_fluor_values./cell_fluor,'DisplayName',num2str(cell_length(end)*pixel_size));
    ...
    hold on
    subplot(1,2,1)
    plot(time_vals,  nuc_fluor_values./cell_fluor,'DisplayName',num2str(cell_length(end)*pixel_size));
...
%     hold on
%     subplot(1,2,2)
%      plot(time_vals/max(time_vals), nuc_fluor_smooth, time_vals/max(time_vals),nuc_fluor_values);
...
%     hold on
%     subplot(1,2,1)
%     plot(time_vals/max(time_vals), cell_fluor_smooth, time_vals/max(time_vals), cell_fluor);
...
%     figure, stem(tlags*time_int, cross_corr)
  figure,
    ...
    ylabel('Cell Length (um)')
    yyaxis left
    p2 = plot(time_vals, nuc_fluor_time./cell_fluor_time, 'b-');
%     p3 = plot(time_vals, cell_fluor_time, 'b--');
%     p4 = plot(time_vals, nuc_fluor_smooth,'k-');
%     p5 = plot(time_vals, nuc_fluor_time,'k--');
    ylabel('N/C Ratio')
    legend([p1, p2],{'Cell Length','N/C Ratio'})
    hold off
    figure, 
      hold on
    yyaxis right
    p1 = plot(time_vals/max(time_vals), cell_length_time);
    ylabel('Cell Length (um)')
    yyaxis left
    p2 = plot(time_vals/max(time_vals), nuc_fluor_time./cell_fluor_time, 'b-');
%     p3 = plot(time_vals, cell_fluor_time, 'b--');
%     p4 = plot(time_vals, nuc_fluor_smooth,'k-');
%     p5 = plot(time_vals, nuc_fluor_time,'k--');
    ylabel('N/C Ratio')
    ...
    hold on
    yyaxis right
     p6 = plot(time_vals/max(time_vals), cell_length_time);
    ylabel('Cell Length (um)')
    yyaxis left
    p7 = plot(time_vals/max(time_vals), cell_intensities_mean);
