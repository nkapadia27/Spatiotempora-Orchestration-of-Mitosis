...
uniq_cell_arr_combined = [uniq_cell_arr_01;uniq_cell_arr_02;uniq_cell_arr_03];
...
background_vals = zeros(num_cells,2);
figure(1)
figure(2)
figure(3)
figure (4)
...
for i=1:num_cells
   ...
   Cdc13_Cyto = cell2mat(cell_dat(:,4));
    ...
    Cdc13_total_cell = cell2mat(cell_dat(:,6));
    background_vals(i,1)= median (Cdc13_Nuc);
    background_vals (i,2) = median (Cdc13_Cyto);
