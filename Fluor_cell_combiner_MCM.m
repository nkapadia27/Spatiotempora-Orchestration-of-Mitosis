...
nucleus_drop = zeros(num_cells,4);
...
%     [min_Cdc13, idx_Cdc13_min] = min(Cdc13_Nuc);
%     nucleus_drop(i) = (max_Cdc13 - Cdc13_Nuc(idx_Cdc13 + 2))/(max_Cdc13 - ;
   ...
   Cdc13_Cyto_smooth = smoothdata(Cdc13_Cyto,'sgolay',4);
     ...
     [max_Cdc13, idx_Cdc13] = max(Cdc13_Nuc);
    [min_Cdc13, idx_Cdc13_min] = min(Cdc13_Nuc);
    nucleus_drop(i,1) = (max_Cdc13 - Cdc13_Nuc(idx_Cdc13 + 2));
    nucleus_drop(i,2) = cell_length_time (end);
    nucleus_drop(i,3) = max_Cdc13-min_Cdc13;
    nucleus_drop(i,4) = max_Cdc13;
